...
export function Exploring() {
  ...
  return <section className={`${s.section} ${s.exploring}`} aria-labelledby="exploring-title">
    <SectionLabel aside="SAME CURIOSITY. A BIGGER CANVAS.">What I’m exploring now</SectionLabel>
    <div className={s.exploringIntro}><h2 id="exploring-title" className={s.heading} data-reveal>Now, I’m exploring<br />what happens when<br /><span className={s.exploringBig}><em>AI</em> meets<br /><em>people.</em></span></h2><figure className={s.exploringCampus}><img {...images['stirling-campus']} alt="University of Stirling campus and loch" loading="lazy" /><figcaption className={s.meta}>The next chapter / Stirling, UK</figcaption></figure><p className={`${s.handwriting} ${s.exploringNote}`}>Curiosity<br />creates<br />what’s next</p></div>
