...
export function ProjectPreview() {
  ...
  return <figure className={s.projectPreview}>
    ...
    {hasError && <p role="alert">The video could not load. <a href={videoUrl} className={s.textLink}>Open the walkthrough ↗</a></p>}
  </figure>;
}
